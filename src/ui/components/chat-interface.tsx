      ...
      {chatHistory.length === 0 && !confirmationOptions && (
        <Box flexDirection="column" marginBottom={2}>
          ...
          <Box marginTop={1} flexDirection="column">
            ...
            <Text color={runtimeConfig.toolsEnabled ? "yellow" : "green"}>
              {runtimeConfig.chatOnly
                ? "Chat-only mode enabled."
                : runtimeConfig.toolsEnabled
                ? `Tools enabled • max rounds: ${runtimeConfig.maxToolRounds}`
                : "Tools disabled for this session."}
            </Text>
          </Box>
        </Box>
      )}

      {chatHistory.length > 0 && runtimeConfig.toolsEnabled && (
        <Box marginBottom={1}>
          <Text color="gray">
            Tip: run <Text color="cyan">grok --chat-only</Text> or{" "}
            <Text color="cyan">grok --no-tools</Text> to disable autonomous tool
            behavior.
          </Text>
        </Box>
      )}
      ...
      {!confirmationOptions && (
        <>
          ...
          <Box flexDirection="row" marginTop={1}>
            ...
            <Box marginRight={2}>
              <Text color={runtimeConfig.toolsEnabled ? "green" : "cyan"}>
                {runtimeConfig.chatOnly
                  ? "Chat-only mode"
                  : runtimeConfig.toolsEnabled
                  ? `Tools enabled • max rounds: ${runtimeConfig.maxToolRounds}`
